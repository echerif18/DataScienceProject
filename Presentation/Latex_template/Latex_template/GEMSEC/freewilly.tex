...
\begin{frame}{ComE}
 \begin{figure}[H]
 	\centering
 	\includegraphics[width=0.7\linewidth]{"../../../Latex Presentation/pics/circular relation"}
 	\caption[Circular realtion between node embedding, community detection, community embedding]{}
